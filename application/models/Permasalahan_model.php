...
class Permasalahan_model extends CI_Model
{
    ...
    {
        $this->db->select('*');
        $this->db->join('siswa', 'siswa.siswa_id = permasalahan.permasalahan_siswa_id');
    ...
    function total_rows($q = NULL) {
        $this->db->like('permasalahan_id', $q);
	$this->db->or_like('permasalahan_siswa_id', $q);
	$this->db->or_like('permasalahan_sekolah', $q);
	$this->db->or_like('permasalahan_keluarga', $q);
	$this->db->or_like('permasalahan_masyarakat', $q);
	$this->db->or_like('permasalahan_teman', $q);
